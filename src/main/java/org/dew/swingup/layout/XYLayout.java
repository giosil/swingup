...
/**
 * Classe per la gestione del layout XY.
 * Il suo funzionamento &egrave; analogo al XYLayout della Borland.
 *
...
class XYLayout implements LayoutManager2, Serializable
{
  ...
  Rectangle
  getComponentBounds(Component component, boolean doPreferred)
  {
  ...
  Dimension
  getLayoutSize(Container target, boolean doPreferred)
  {
