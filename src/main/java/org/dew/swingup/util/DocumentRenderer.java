...
/**
 * Tale classe permette di gestire la stampa di un JEditorPane.
 *
...
public class DocumentRenderer implements Printable {
  ...
  */
  public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) {
    ...
    //  V
    // giosil: si aumenta di 16 la regione di clipping per evitare che
    //         vengano tagliati i caratteri vicini al margine destro.
    graphics2D.setClip((int)(pageFormat.getImageableX()/scale),
      (int)(pageFormat.getImageableY()/scale),
      (int)(pageFormat.getImageableWidth()/scale) + 16,
      (int)(pageFormat.getImageableHeight()/scale) + 16);
    //  VI
  ...
  */
  ...
  /*  print(HTMLDocument) is called to set an HTMLDocument for printing.
  *   giosil: Ho aggiungo il parametro per il dialogo delle stampanti.
  */
  public void print(HTMLDocument htmlDocument, boolean boPrintDialog) {
    setDocument(htmlDocument);
    printDialog(boPrintDialog);
  }
  ...
  */
   ...
   *   giosil: Ho aggiungo il parametro per il dialogo delle stampanti.
   */
  public void print(JEditorPane jedPane, boolean boPrintDialog) {
    setDocument(jedPane);
    printDialog(boPrintDialog);
  }
  ...
  */
   ...
   *   giosil: Ho aggiungo il parametro per il dialogo delle stampanti.
   */
  public void print(PlainDocument plainDocument, boolean boPrintDialog) {
    setDocument(plainDocument);
    printDialog(boPrintDialog);
  }
  ...
  giosil: ho aggiunto un parametro che permette di specificare se
  far apparire o meno il dialogo delle stampanti.
  */
  protected void printDialog(boolean boPrintDialog) {
    boolean boPrint = true;
    if(boPrintDialog) {
      boPrint = pJob.printDialog();
    }
